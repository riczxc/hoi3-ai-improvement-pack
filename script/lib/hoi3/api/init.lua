...
require('hoi3.api.CArrayFix64')
require('hoi3.api.CArrayFloat')
require('hoi3.api.CArrayInt')
require('hoi3.api.CBrigadeConstructionDefinition')
...
require('hoi3.api.CChangeMinisterCommand')
...
require('hoi3.api.CCreateVassalCommand')
...
require('hoi3.api.CMinisterType')
require('hoi3.api.CMinisterTypeDataBase')
...
require('hoi3.api.CUpgradeRegimentCommand')
require('hoi3.api.CVariables')
