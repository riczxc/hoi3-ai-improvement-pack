...
-- @since 1.3
-- @return CNullTag
hoi3.f(CNullFaction, 'GetTag', 'CCountryTag')
...
-- @since 1.3
-- @return void
hoi3.f(CNullFaction, 'GetFactionLeader', hoi3.TYPE_VOID)
...
-- @since 1.3
-- @return void
hoi3.f(CNullFaction, 'GetIdeologyGroup', hoi3.TYPE_VOID)

---
-- @since 1.3
-- @return iterator<CCountryTag>
hoi3.f(CNullFaction, 'GetMembers', hoi3.TYPE_VOID)

---
-- @since 1.3
-- @return CFixedPoint
hoi3.f(CNullFaction, 'GetNormalizedProgress', hoi3.TYPE_VOID)

---
-- @since 1.3
-- @derived CNullFaction:GetMembers()
-- @return number
hoi3.f(CNullFaction, 'GetNumberOfMembers', hoi3.TYPE_NUMBER)
...
-- @param unknown
-- @return unknown
hoi3.f(CNullFaction, 'GetProgress', hoi3.TYPE_UNKNOWN, hoi3.TYPE_UNKNOWN)

---
-- @since 1.3
-- @return bool
hoi3.f(CNullFaction, 'IsValid', hoi3.TYPE_BOOLEAN)
