function LoadProductionRatio(minister, ministerCountry)
	...
	if ministerTag == 'GER' then
		...
		prod_ratio['infantry_brigade'] = { 	-- Infantry
		...
		prod_ratio['mechanized_brigade'] = {	-- mechanized
		...
		if ministerCountry:GetTechnologyStatus():IsUnitAvailable(mechanized) then
			prod_ratio['armor_brigade'] = {		-- Armor with mechanized
			...
			prod_ratio['armor_brigade'] = {		-- Armor with motorized
