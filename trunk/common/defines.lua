...
country = {
	...
	SPY_THREAT_INCREASE_ACTION = 0.02,	-- daily threat increase from spy action
...
military = {
	...
	RIVER_CROSSING_PENALTY = 0.3,	-- base river crossing penalty.
	AMPHIBIOUS_LANDING_PENALTY = -0.4,	-- amphibious landing penalty
	PARADROP_PENALTY = -0.3,	-- paradrop penalty
	...
	LAND_COMBAT_THREAT_IMPACT = 0.5,
	NAVAL_COMBAT_THREAT_IMPACT = 1.0,
	AIR_COMBAT_THREAT_IMPACT = 0.05,
	BOMBING_THREAT_IMPACT = 0.25,
...
diplomacy = {
	...
	NEUT_INCREASE_DIFF_CONTINENT = 25,
...
weather = {
	...
	GFX_RAIN_LIMIT						= 0.1,
	GFX_SNOW_LIMIT						= 0.1,
	GFX_STORM_LIMIT						= 10.0,
	GFX_SNOW_STORM_LIMIT				= 10.0,
