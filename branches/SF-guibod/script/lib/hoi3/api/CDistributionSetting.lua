...
CDistributionSetting = hoi3.Hoi3Object:subclass('hoi3.api.CDistributionSetting')

---
-- @since 1.3
-- @return CFixedPoint
hoi3.f(CDistributionSetting, 'GetNeeded', 'CFixedPoint')

---
-- @since 1.3
-- @param unknown
-- @return unknown
hoi3.f(CDistributionSetting, 'GetPercentage', hoi3.TYPE_UNKNOWN, hoi3.TYPE_UNKNOWN)
